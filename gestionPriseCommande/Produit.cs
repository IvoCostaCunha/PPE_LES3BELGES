...
namespace les3belges
{
    public class Produit  
    {
        ...
        //Constructeur #1
        public Produit(string uneRef, string unLibelle, double unPrixUHT, int unStockTheorique, double unTauxTVA, int unStockTemp, string uneCouleur, string uneTaille, string uneOrigine, int unDelai, int unSeuil)
        {
