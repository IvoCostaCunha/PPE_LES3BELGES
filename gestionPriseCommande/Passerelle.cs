        ...
        public static Produit getProduit(string uneReference)
        {
            ...
            if (ClassReq.RetConnOk() == true)
            {
                ...
                if (resultat.Rows.Count == 1)
                {
                    ...
                    res = new Produit(referenceProd, libelleProduit, prixUHT, stockTheorique, tauxTVA, stockTemp, couleurProduit, tailleProduit, origineProduit, delaiReapro, seuilReapro );
